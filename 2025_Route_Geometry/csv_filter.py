...
data = pd.read_csv('Project_Python\\2025_Route_Geometry\\車速中位數\\202501_normalspeed.csv')
...
weighted_avg_speed.to_csv('Project_Python\\2025_Route_Geometry\\車速中位數\\202501_normalspeed_weighted.csv', index=False, header=True)
